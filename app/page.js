                              ...
                              <div style={{flex:1,minWidth:0}}>
                                ...
                                {ocupado.refPhoto&&ocupado.status!=='completed'&&(
                                  <details style={{marginTop:6}}>
                                    <summary style={{fontSize:10,color:T.primary,fontWeight:700,cursor:'pointer',listStyle:'none'}}>
                                      📎 Ver referência ▾
                                    </summary>
                                    <img src={ocupado.refPhoto} alt="Referência"
                                      style={{width:'100%',maxHeight:200,objectFit:'cover',borderRadius:10,marginTop:8,
                                        border:`1px solid ${T.primaryPale}`,display:'block'}}/>
                                  </details>
                                )}
                              </div>
                            ):(
