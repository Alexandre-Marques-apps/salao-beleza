      ...
      <div className="login-wrap">
        <div className="login-card">
          <div className="login-hero">
            <div className="login-name">{salonName}</div>
                            ...
                            {ocupado?(
                              <div style={{flex:1,minWidth:0}}>
                                ...
                                {ocupado.refPhoto&&ocupado.status!=='completed'&&(
                                  <div style={{marginTop:6,fontSize:10,color:T.primary,fontWeight:700}}>📎 Ver referência</div>
                                )}
                              </div>
                            ):(
                    ...
                    <div key={a.id} className="res-card" style={{flexDirection:'column',alignItems:'stretch'}}>
                      ...
                      {a.status!=='completed'&&a.refPhoto&&(
                        <div style={{marginTop:10}}>
                          <div style={{fontSize:10,fontWeight:700,color:'#aaa',marginBottom:6,textTransform:'uppercase',letterSpacing:1}}>
                            📎 Minha referência
                          </div>
                          <img src={a.refPhoto} alt="Referência"
...
export default function Joudat(){
  const [salonName,setSalonName]=useState(()=>{
    try{const c=localStorage.getItem('joudat_funcionamento');return c?JSON.parse(c).nome||'Joudat Salon':'Joudat Salon'}catch{return 'Joudat Salon'}
  })
  // Atualizar salonName quando FuncionamentoAdmin salvar
  useEffect(()=>{
